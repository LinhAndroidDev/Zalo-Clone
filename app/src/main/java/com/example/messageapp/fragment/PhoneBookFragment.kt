...
class PhoneBookFragment :
    ...
    private fun setupAlphabetScroll() {
        binding?.rcvPhoneBook?.apply {
            ...
            setPreviewPadding(0)
            setIndexBarTextColor(R.color.text_muted)
            setPreviewTextSize(22)
            setPreviewColor(R.color.color_link)
            setPreviewTextColor(R.color.text_on_color)
            ...
            setIndexBarStrokeColor(R.color.text_muted)
            setIndexBarHighLightTextColor(R.color.text_primary)
