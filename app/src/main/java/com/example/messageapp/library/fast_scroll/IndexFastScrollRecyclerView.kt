 ...
 */   class IndexFastScrollRecyclerView : RecyclerView {
    ...
    @ColorInt
    var mIndexBarBackgroundColor = Color.WHITE
    ...
    /**
     * @param value float to set the background color of the index bar
     */
    fun setIndexBarBackGroundColor(@ColorRes value: Int) {
        mIndexBarBackgroundColor = ContextCompat.getColor(context, value)
    }
    ...
    /**
     * @param value float to set corner radius value of the preview box
     */
    fun setPreviewCornerRadiusValue(value: Int) {
        mScroller?.setPreviewCornerRadius(value)
    }
