package com.example.messageapp.library.indicator;
...
public class CircleIndicator extends View{
    ...
    //default value
    private final static int DEFAULT_INDICATOR_RADIUS = 10;
    private final static int DEFAULT_INDICATOR_MARGIN = 40;
    private final static int DEFAULT_INDICATOR_BACKGROUND = Color.BLUE;
    private final static int DEFAULT_INDICATOR_SELECTED_BACKGROUND = Color.RED;
    private final static int DEFAULT_INDICATOR_LAYOUT_GRAVITY = Gravity.CENTER.ordinal();
    private final static int DEFAULT_INDICATOR_MODE = Mode.SOLO.ordinal();
    public enum Gravity{
        LEFT,
        CENTER,
        RIGHT
